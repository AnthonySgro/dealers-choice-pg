module.exports = sqlSeed = () => {
    ...
    DROP TABLE IF EXISTS athlete_type_freq;
    ...
    AS
    SELECT workouts.workout_id, workouts.athlete_id, athletes.name AS athlete, exercises.name AS exercise, exercises.category, workouts.date
    FROM workouts
